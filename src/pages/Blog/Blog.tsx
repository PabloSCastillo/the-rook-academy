                ...
                <section className="bg-[#f6f3f2] py-24 px-8">
                    <div className="max-w-7xl mx-auto">
                        <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-16 gap-6 text-center md:text-left">
                            ...
                            <button className="text-[#005a5a] font-bold font-label border-b-2 border-[#005a5a] pb-1   transition-all uppercase text-sm tracking-widest">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                            ...
                            <div className="lg:col-span-4 flex flex-col gap-4">
                                {[
                                    ...
                                    <div key={idx} className={`bg-white p-6 group cursor-pointer border-l-4 ${video.border} shadow-sm transition-shadow`}>
                                        <span className="font-bold font-label text-[10px] uppercase block mb-2 opacity-70 tracking-widest">{video.cat}</span>
                                        <h4 className="font-headline text-lg font-bold text-[#005a5a]  transition-colors uppercase">{video.title}</h4>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {[10, 11, 12].map((imgNum) => (
                            <article key={imgNum} className="flex flex-col group">
                                ...
                                <h3 className="font-headline text-xl font-bold text-[#005a5a] mb-4 leading-tight uppercase  transition-colors">La ventaja cognitiva en el aprendizaje</h3>
                        ...
                        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <form className="flex flex-col sm:flex-row gap-0" onSubmit={(e) => e.preventDefault()}>
                                <input
                                    ...
                                    type="email"
                                />
                                <button className="bg-[#944921] text-white px-8 py-4 font-headline font-bold uppercase tracking-widest text-xs  transition-colors whitespace-nowrap">
                                    OK
                                </button>
                            </form>
                        </div>
